...
│  │ [SSE实时显示]                                                       │   │
│  │ AI思考: 正在分析攻击链路...                                          │   │
│  │ 🔧 调用工具: GetProcessTree(host="app-server-01", pid=12345)         │   │
│  │ 📥 工具返回: bash(12345) → python(11111) → nc(22222)                 │   │
│  │ AI思考: 基于进程链分析，这可能是反弹shell攻击...                      │   │
│  │                                                                      │   │
│  │ [降噪完成 - 只显示攻击溯源图]                                        │   │
│  │ ┌─────────────────────────────────────────────────────────────────┐ │   │
│  │ │              👤 攻击者 (1.2.3.4)                                │ │   │
...
│  │ │                     │ SSH连接                                     │ │   │
│  │ │                     ↓                                             │ │   │
│  │ │         🖥️ WebServer ─ ⚙️ bash ─ ⚙️ nc ─ 🌐 C2              │ │   │
│  │ │           (victim)   (12345)   (12346)   (外连4444)              │ │   │
│  │ │                                                                  │ │   │
│  │ │  🟢 严重威胁   [适应视图] [导出PNG]                               │ │   │
│  │ └─────────────────────────────────────────────────────────────────┘ │   │
│  │                                                                      │   │
...
| RAG增强 | 基于历史相似案例辅助分析 |
| 攻击溯源图 | 分析完成后以可视化攻击链路图展示（科技感、交互性）**【核心新增】** |
