...
func RegisterAuditTools(registry *assistant.ToolRegistry, deps AuditToolDeps) error {
	if err := registry.Register(&assistant.ToolSpec{
		...
		Description:        "List audit logs with script-type, audit-source, and review-result filters.",
		...
		ArgsSchema: map[string]interface{}{
			...
			"properties": map[string]interface{}{
				...
				"script_type":  map[string]interface{}{"type": "string", "description": "Script type filter."},
				"audit_source": map[string]interface{}{"type": "string", "description": "Audit source filter."},
				"passed":       map[string]interface{}{"type": "string", "enum": []interface{}{"true", "false"}, "description": "Review result as true or false."},
			},
		},
