...
func builtinWorkflowSpecs() []WorkflowSpec {
	return []WorkflowSpec{
		...
		{ID: "vulnerability_remediation", Version: "6.1", Domain: DomainVulnerability, Goal: "Generate, execute, and verify CVE proof or remediation scripts.", TriggerIntents: []string{"verify", "remediate", "fix"}, ObjectTypes: []string{"cve", "vulnerability", "host"}, Risk: ToolRiskHigh},
		...
		{ID: "sigma_rule_lifecycle", Version: "6.1", Domain: DomainSigmaRule, Goal: "Generate and validate Sigma rules against evidence before packaging.", TriggerIntents: []string{"sigma", "detection_rule"}, ObjectTypes: []string{"sigma_rule", "alert"}, Risk: ToolRiskMedium},
