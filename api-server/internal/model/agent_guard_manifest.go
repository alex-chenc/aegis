...
var builtinAgentGuardProfiles = []AgentGuardAdapterProfile{
	{
		...
		DefaultEscapeRules: jsonValue(`["join_external_namespace","mount_host_path","credential_or_capability_gain","isolation_baseline_drift"]`),
	...
	},
	{
		...
		DefaultEscapeRules: jsonValue(`["access_container_runtime_socket","join_external_namespace","mount_host_path","write_cgroupfs","credential_or_capability_gain","isolation_baseline_drift"]`),
